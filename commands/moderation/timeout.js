...
module.exports = {
    data: new SlashCommandBuilder()
		...
		.addStringOption(option =>
			option
				.setName('amount')
				.setDescription('The duration of the timeout (max 28 days) e.g. 1d | 2 weeks | 3hrs')
				.setRequired(true))
		.addStringOption(option =>
			option
				.setName('reason')
    ...
    async execute(interaction) {
        ...
        if (targetUserRolePosition >= requestUserRolePosition) {
            await interaction.editReply({
                embeds: [
                    new EmbedBuilder()
                        .setTitle('ERROR')
                        .setDescription('You cannot timeout someone with a higher or equal role than you')
                        .setColor('Red')
                        .setFooter({
                            text: `Done by: ${interaction.user.username}`,
                            iconURL: `${interaction.user.avatarURL()}`,
        ...
        if (targetUserRolePosition >= botRolePosition) {
            await interaction.editReply({
                embeds: [
                    new EmbedBuilder()
                        .setTitle('ERROR')
                        .setDescription('I cannot timeout someone with a higher or equal role than myself')
                        .setColor('Red')
                        .setFooter({
                            text: `Done by: ${interaction.user.username}`,
                            iconURL: `${interaction.user.avatarURL()}`,
        ...
        try {
            ...
            const newTimeoutDuration = targetUser.communicationDisabledUntilTimestamp && targetUser.communicationDisabledUntilTimestamp > currentTime
            ...
            if (newTimeoutDuration <= 0) {
                ...
                await interaction.editReply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(`<@${targetUser.id}>'s timeout has been removed. Reason: \`${reason}\``)
                            .setColor('Green')
                            .setFooter({
                                text: `Done by: ${interaction.user.username}`,
                                iconURL: `${interaction.user.avatarURL()}`,
                ...
                await interaction.editReply({
                    embeds: [
                        new EmbedBuilder()
                            .setTitle('ERROR')
                            .setDescription('The total timeout duration exceeds the maximum limit of 28 days.')
                            .setColor('Red')
                            .setFooter({
                                text: `Done by: ${interaction.user.username}`,
                                iconURL: `${interaction.user.avatarURL()}`,
                ...
                await interaction.editReply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(`<@${targetUser.id}>'s timeout has been updated. Reason: \`${reason}\`\nNew Duration: \`${ms(newTimeoutDuration, { long: true })}\``)
                            .setColor('Green')
                            .setFooter({
                                text: `Done by: ${interaction.user.username}`,
                                iconURL: `${interaction.user.avatarURL()}`,
