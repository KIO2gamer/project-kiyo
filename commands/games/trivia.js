...
module.exports = {
	...
	async execute(interaction) {
		try {
			...
			const decodedAnswers = questionData.incorrect_answers.map(answer => he.decode(answer));
			...
			collector.on('collect', async msg => {
				...
				if (userAnswer === correctAnswer) {
					...
					await timerMessage.edit(`<@${msg.author.id}> got the correct answer!`); // Announce the winner
				} else {
