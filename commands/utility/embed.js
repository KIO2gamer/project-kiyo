    ...
    async execute(interaction) {
        ...
        const embeds = {
            welcome: new EmbedBuilder()
                ...
                .setColor("Purple")
                .setFooter({ text: 'Enjoy your stay!', iconURL: 'https://example.com/icon.png' }),
            ...
            role_ranks: new EmbedBuilder()
                ...
                .addFields(
                    { name: `No Rank Perks`, value: `- ${roles.wood}\n- ${roles.coal}\n- ${roles.iron}\n- ${roles.amethyst}\n- ${roles.ruby}\n- ${roles.opal}\n- ${roles.god_grinder}`, inline: true },
                    { name: `Available Rank Perks`, value: `- ${roles.bronze} \n - Permission to change your username.\n- ${roles.gold} \n - Get access to <#950318340889518150> and <#950318103739400202>\n- ${roles.platinum} \n - Get image permissions in <#1239619089425764362>\n- ${roles.diamond} \n - Get link permissions in <#1239619089425764362>\n- ${roles.sapphire} \n - Get access to use other emojis in the server.\n- ${roles.netherite} \n - Get a custom role in the server (Open a ticket in <#1170620573613826068>)\n- ${roles.emerald} \n - Get a custom role icon in the server (Open a ticket in <#1170620573613826068>)`, inline: true }
                )
                .setThumbnail('https://example.com/rank.png')
                .setColor("Purple")
                .setFooter({ text: 'Keep chatting to level up!', iconURL: 'https://example.com/icon.png' }),
            ...
            role_booster: new EmbedBuilder()
                ...
                .setColor("Purple")
                .setFooter({ text: 'Thank you for boosting!', iconURL: 'https://example.com/icon.png' }),
            
            role_others: new EmbedBuilder()
                .setTitle("🎭 Miscellaneous Roles Information 🎭")
                .setDescription("Below are the roles which are given to specific members under specific conditions.")
                .addFields(
                    { name: `Owners`, value: `${roles.owner} is <@764513584125444146>\n${roles.coowner} is <@787259868049571842>\nWe are the founders of this server.`, inline: true },
                    { name: `Admin`, value: `${roles.admin} - These are the highest possible staff members in this server. They have the permissions to alter the server's settings. This role can only be given to those picked by the server owner.`, inline: true },
                    { name: `Moderator`, value: `${roles.moderator} - These are the staff members who have a great experience in moderating the server, You can get it if you get promoted from ${roles.traineemod}`, inline: true },
                    { name: `Trainee Moderator`, value: `${roles.traineemod} - These are second type of staff members who just joined the team but needs more experience in the server. You can get it if you get accepted in the Moderator Applications.`, inline: true },
                    { name: `OG Members`, value: `${roles.og_members} - These members are the ones who first joined this server when it was created. You can't get this role anymore.`, inline: true },
                    { name: `Subscriber`, value: `${roles.subscriber} - These members have subscribed to [KIO2gamer](https://www.youtube.com/@kio2gamer). You can get this role in <#1180862022099947531>`, inline: true },
                )
                .setThumbnail('https://example.com/misc.png')
                .setColor("Purple")
                .setFooter({ text: 'Role info', iconURL: 'https://example.com/icon.png' }),

            forms: new EmbedBuilder()
                .setTitle("📋 Forms 📋")
                .setDescription("Below are some forms for various applications.")
                .addFields(
                    { name: "Moderator Application", value: "> Go to [Moderator Applications](https://forms.gle/GJMUUiSjLPuiLvmA9) and fill up the form." },
                    { name: "Ban/Mute Appeal", value: "> Go to [Ban / Mute Appeal Form](https://forms.gle/6M5wgndJj6r3W7KD8) and fill it up." }
                )
                .setThumbnail('https://example.com/forms.png')
                .setColor("Purple")
                .setFooter({ text: 'Submit your forms!', iconURL: 'https://example.com/icon.png' }),
            ...
            rules: new EmbedBuilder()
                ...
                .setColor("Purple")
                .setFooter({ text: 'Follow the rules!', iconURL: 'https://example.com/icon.png' }),

            own_roles: [
                new EmbedBuilder()
                    .setTitle("📣 Are you subscribed to KIO2gamer? 📣")
                    .setDescription("If you are subscribed, click the green button to get access to <#1237247763910234132> and <#1237247979103064145>")
                    .setColor("Purple")
                    .setThumbnail('https://example.com/subscriber.png')
                    .setFooter({ text: 'Thanks for subscribing!', iconURL: 'https://example.com/icon.png' }),
                
                new EmbedBuilder()
                    .setTitle("🌍 Where are you from? 🌍")
                    .setDescription("Choosing this role can often help people know when you may be most active on this server.")
                    .setColor("Purple")
                    .setThumbnail('https://example.com/location.png')
                    .setFooter({ text: 'Set your location!', iconURL: 'https://example.com/icon.png' }),

                new EmbedBuilder()
                    .setTitle("🚻 What is your gender? 🚻")
                    .setDescription("You may use Discord's new `Pronouns Textbox` or either take from one of these roles. It helps to identify who you truly are and use your pronouns carefully without triggering everyone. We treat every community the same respect in this server.")
                    .setColor("Purple")
                    .setThumbnail('https://example.com/gender.png')
                    .setFooter({ text: 'Set your gender!', iconURL: 'https://example.com/icon.png' }),

                new EmbedBuilder()
                    .setTitle("💻 What is your platform? 💻")
                    .setDescription("Perfect roles for those who might be searching for someone who might have the same platform to play, watch and enjoy together.")
                    .setColor("Purple")
                    .setThumbnail('https://example.com/platform.png')
                    .setFooter({ text: 'Set your platform!', iconURL: 'https://example.com/icon.png' }),

                new EmbedBuilder()
                    .setTitle("🎨 What is your hobby? 🎨")
                    .setDescription("This role is perfect for those who are looking for someone who is into the same hobby as you.")
                    .setColor("Purple")
                    .setThumbnail('https://example.com/hobby.png')
                    .setFooter({ text: 'Set your hobby!', iconURL: 'https://example.com/icon.png' })
            ]
        };
        ...
        try {
            if (textChosen in embeds) {
                ...
                await interaction.channel.send({ embeds: [embeds.role_ranks, embeds.role_booster, embeds.role_others] });
            } else {
