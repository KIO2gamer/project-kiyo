...
const commandBuilder = new SlashCommandBuilder()
	...
	.addStringOption(option =>
		option.setName('color').setDescription('The color of the role').setRequired(false)
	)
	.addBooleanOption(option =>
		option.setName('hoist').setDescription('Display role members separately').setRequired(false)
	)
	.addBooleanOption(option =>
		option
			.setName('mentionable')
