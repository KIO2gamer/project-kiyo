...
module.exports = {
	...
	usage: '/edit_role <role:role> [name:new_name] [color:#hexcolor] [hoist:true/false] [mentionable:true/false]',
	examples: [
		'/edit_role role:Members name:NewMembers color:#00FF00',
		'/edit_role role:Announcements hoist:true',
	],
	category: 'roles',
	data: new SlashCommandBuilder()
		...
		.addBooleanOption(option =>
			option.setName('mentionable').setDescription('Whether the role should be mentionable'),
		),
	async execute(interaction) {
		...
		try {
			...
			return interaction.reply('An error occurred while updating the role.');
		}
	},
};
